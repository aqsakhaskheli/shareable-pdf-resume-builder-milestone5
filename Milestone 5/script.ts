...
const name = (document.getElementById('name') as HTMLInputElement).value
    ...
    const othereducation = (document.getElementById('othereducation') as HTMLTextAreaElement).value
...
resumeData.name;
(document.getElementById('fathersname') as HTMLInputElement).value =
...
(document.getElementById('nic') as HTMLInputElement).value =
resumeData.nic;
...
(document.getElementById('othereducation') as HTMLTextAreaElement).value =
resumeData.othereducation
